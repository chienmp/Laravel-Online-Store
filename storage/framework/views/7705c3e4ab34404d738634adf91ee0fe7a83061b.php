							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									...
									<div class="form-group" >
					                    ...
					                    <img id="avatar" class="thumbnail" width="300px" src="<?php echo e(asset('img/upload-cloud.png')); ?>">
									</div>
									<div class="form-group" >
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\project-lar\resources\views/backend/addproduct.blade.php ENDPATH**/ ?>